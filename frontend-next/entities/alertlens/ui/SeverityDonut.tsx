...
export function SeverityDonut({ slices }: { slices: SeveritySlice[] }) {
  ...
  return (
    // Intrinsic layout, no breakpoints: the donut and the legend sit side by
    // side while there is room, and the legend wraps under the donut when the
    // panel is narrow. The legend grid then fits as many columns as its own
    // width allows, so it adapts to wherever the panel is placed.
